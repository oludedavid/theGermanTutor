...
export const courseData: CourseDataT[] = [
  ...
  {
    id: "6",
    title: "C2 – Mastery Level",
    description:
      "Refine your German to an expert level, mastering nuances of expression, argumentation, and style across academic, cultural, and professional settings.",
    level: "C2",
    price: 450,
    imageUrl: "/course2.png",
    duration: "14 weeks",
    whatYouWillLearn: [
      "Mastery of idiomatic expressions and stylistic variations",
      "Understanding and producing complex academic and literary texts",
      "Engaging in sophisticated discussions and debates",
      "Perfecting pronunciation, rhythm, and articulation for native-like fluency",
    ],
    schedule: {
      daysOfWeek: ["Tuesday", "Thursday"],
      time: "6:00 PM - 8:00 PM",
      coursePeriod: ["Feb 1 - May 10", "May 20 - Aug 28"],
    },
  },
  {
    id: "7",
